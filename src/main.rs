...
fn main() {
    ...
    if let Ok(day05_input) = day05::prepare("day05.txt") {
        let day05_part1 = day05::part_1(&day05_input);
        let day05_part2 = day05::part_2(&day05_input);
        println!("🌟 {}", day05_part1.unwrap_or(0));
        println!("🌟 {}", day05_part2.unwrap_or(0));
